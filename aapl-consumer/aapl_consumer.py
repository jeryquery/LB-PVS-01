...
def process_batch():
    ...
    if message_count > 0:
        ...
        print(f"Saving average price for AAPL: {avg_price}")
        collection.insert_one({"company": "AAPL", "avgPrice": avg_price})
...
print('Waiting for AAPL messages. To exit press CTRL+C')
try:

...
rabbitmq_user = os.getenv("RABBITMQ_DEFAULT_USER", "default_user")  # Default als Fallback
...
def process_batch():
    ...
    if message_count > 0:
        ...
        print(f"Saving average price for TSLA: {avg_price}")
        collection.insert_one({"company": "TSLA", "avgPrice": avg_price})
...
print('Waiting for TSLA messages. To exit press CTRL+C')
try:
